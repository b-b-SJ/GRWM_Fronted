...
const PostingStyle = () => {
  ...
  //둘 다 아이디 필요 -> 각 유저 아이디/포스팅 아이디 | 아이디 부분들은 완전 가라임 -> 각자 타임라인 부분에서 불려와야함
  const postWriterData = posts.getUserSimpProfile("youyousangjong");
  const postContentData = posts.getContent("21");
