          ...
          <div className="flex justify-between items-center mb-6">
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">
                ...
                {isExpired && (
                  <span className="text-red-500 ml-2">(마감됨)</span>
                )}
              </p>
            </div>
            <button
                ...
                <thead>
                  <tr>
                    ...
                    {currentVote.voteRange?.map((date) => (
                      <th
                        key={date}
                        className="border p-2 bg-gray-100 min-w-[120px]"
                      >
                        ...
                        return (
                          <td
                            ...
                            onMouseDown={() =>
                              !isExpired &&
                              mode === "vote" &&
                              handleSlotMouseDown(date, time)
                            }
                            onMouseEnter={() =>
                              !isExpired &&
                              mode === "vote" &&
                              handleSlotMouseEnter(date, time)
                            }
            ...
            >
              <div className="flex justify-between items-start mb-4">
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-1">
                    {new Date(selectedSlotInfo.date).toLocaleDateString(
                      "ko-KR",
                      {
                        month: "short",
                        day: "numeric",
              ...
              <div className="mb-4">
                <div className="flex items-center gap-2 text-sm text-gray-700">
                  ...
                  <span className="font-semibold">
                    {selectedSlotInfo.count}명이 투표 (
                    {selectedSlotInfo.percentage.toFixed(0)}%)
                  </span>
                </div>
              </div>
