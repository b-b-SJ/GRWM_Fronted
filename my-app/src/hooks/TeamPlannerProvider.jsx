...
export const TeamPlannerProvider = ({ children }) => {
        ...
        async (loginId) => {
            ...
            try {
                const response = await fetch(
                    `${API_BASE_URL}/api/users/find/${loginId}`,
                    {
                        method: "GET",
                        headers: {
                            ...getAuthHeaders(),
    ...
    const fetchPlanners = useCallback(async () => {
        ...
        setError(null);
        try {
            const response = await fetch(`${API_BASE_URL}/api/team-planner/list`, {
                method: "GET",
                headers: {
                    ...getAuthHeaders(),
                    "Content-Type": "application/json",
    ...
    const fetchMembers = useCallback(
        async (plannerId) => {
            ...
            setError(null);
            try {
                const response = await fetch(`${API_BASE_URL}/api/team-planner/${plannerId}/member`, {
                    method: "GET",
                    headers: {
                        ...getAuthHeaders(),
                        "Content-Type": "application/json",
    ...
    const fetchCategories = useCallback(
        async (plannerId) => {
            ...
            try {
                const response = await fetch(
                    `${API_BASE_URL}/api/team-planner/${plannerId}/category`,
                    {
                        method: "GET",
                        headers: {
                            ...getAuthHeaders(),
    ...
    const createPlanner = useCallback(
        async (plannerData) => {
            ...
            try {
                ...
                const response = await fetch(`${API_BASE_URL}/api/team-planner/create`, {
                    method: "POST",
                    headers: {
                        ...getAuthHeaders(),
                        "Content-Type": "application/json",
        ...
        [currentUser.userId, getAuthHeaders, fetchPlanners, handleError, checkAuth]
    );
    ...
    const updatePlanner = useCallback(
        async (plannerId, updateData) => {
            ...
            setError(null);
            try {
                const response = await fetch(`${API_BASE_URL}/api/team-planner/${plannerId}/update`, {
                    method: "PUT",
                    headers: {
                        ...getAuthHeaders(),
                        "Content-Type": "application/json",
    ...
    const deletePlanner = useCallback(
        async (plannerId) => {
            ...
            setError(null);
            try {
                const response = await fetch(`${API_BASE_URL}/api/team-planner/${plannerId}/delete`, {
                    method: "DELETE",
                    headers: {
                        ...getAuthHeaders(),
                        "Content-Type": "application/json",
    ...
    const addMember = useCallback(
        async (plannerId, memberId, role) => {
            ...
            try {
                const response = await fetch(
                    `${API_BASE_URL}/api/team-planner/${plannerId}/member/${memberId}/${role}`,
                    {
                        method: "POST",
                        headers: {
                            ...getAuthHeaders(),
        ...
        [getAuthHeaders, fetchMembers, handleError, checkAuth]
    );
    ...
    const removeMember = useCallback(
        async (plannerId, memberId) => {
            ...
            try {
                const response = await fetch(
                    `${API_BASE_URL}/api/team-planner/${plannerId}/member/${memberId}`,
                    {
                        method: "DELETE",
                        headers: {
                            ...getAuthHeaders(),
    ...
    const updateMemberNickname = useCallback(
        async (plannerId, memberId, nickname) => {
            ...
            try {
                const response = await fetch(
                    `${API_BASE_URL}/api/team-planner/${plannerId}/member/${memberId}/${nickname}`,
                    {
                        method: "PUT",
                        headers: {
                            ...getAuthHeaders(),
    ...
    const createSchedule = useCallback(
        async (plannerId, scheduleData) => {
            ...
            try {
                const response = await fetch(
                    `${API_BASE_URL}/api/team-planner/${plannerId}/schedule/create`,
                    {
                        method: "POST",
                        headers: {
                            ...getAuthHeaders(),
    ...
    const fetchScheduleDetail = useCallback(
        async (plannerId, scheduleId) => {
            ...
            try {
                const response = await fetch(
                    `${API_BASE_URL}/api/team-planner/${plannerId}/schedule/${scheduleId}`,
                    {
                        method: "GET",
                        headers: {
                            ...getAuthHeaders(),
    ...
    const updateSchedule = useCallback(
        async (plannerId, scheduleId, updateData) => {
            ...
            try {
                const response = await fetch(
                    `${API_BASE_URL}/api/team-planner/${plannerId}/schedule/${scheduleId}/edit`,
                    {
                        method: "PUT",
                        headers: {
                            ...getAuthHeaders(),
    ...
    const deleteSchedule = useCallback(
        async (plannerId, scheduleId) => {
            ...
            try {
                const response = await fetch(
                    `${API_BASE_URL}/api/team-planner/${plannerId}/schedule/${scheduleId}/delete`,
                    {
                        method: "DELETE",
                        headers: {
                            ...getAuthHeaders(),
    ...
    const updateScheduleDateTime = useCallback(
        async (plannerId, scheduleId, dateTime) => {
            ...
            try {
                const response = await fetch(
                    `${API_BASE_URL}/api/team-planner/${plannerId}/schedule/${scheduleId}/drag-drop`,
                    {
                        method: "PUT",
                        headers: {
                            ...getAuthHeaders(),
    ...
    const joinSchedule = useCallback(
        async (plannerId, scheduleId, userId) => {
            ...
            try {
                const response = await fetch(
                    `${API_BASE_URL}/api/team-planner/${plannerId}/schedule/${scheduleId}/join/${userId}`,
                    {
                        method: "POST",
                        headers: {
                            ...getAuthHeaders(),
    ...
    const addScheduleMember = useCallback(
        async (plannerId, scheduleId) => {
            ...
            try {
                const response = await fetch(
                    `${API_BASE_URL}/api/team-planner/${plannerId}/schedule/${scheduleId}/add-member`,
                    {
                        method: "POST",
                        headers: {
                            ...getAuthHeaders(),
    ...
    const removeScheduleMember = useCallback(
        async (plannerId, scheduleId) => {
            ...
            try {
                const response = await fetch(
                    `${API_BASE_URL}/api/team-planner/${plannerId}/schedule/${scheduleId}/delete-member`,
                    {
                        method: "DELETE",
                        headers: {
                            ...getAuthHeaders(),
    ...
    const fetchMonthlySchedules = useCallback(
        async (plannerId, year, month) => {
            ...
            try {
                const response = await fetch(
                    `${API_BASE_URL}/api/team-planner/${plannerId}/schedule/monthly/${year}/${month}`,
                    {
                        method: "GET",
                        headers: {
                            ...getAuthHeaders(),
    ...
    const fetchWeeklySchedules = useCallback(
        async (plannerId, year, weekNumber) => {
            ...
            try {
                const response = await fetch(
                    `${API_BASE_URL}/api/team-planner/${plannerId}/schedule/weekly/${year}/${weekNumber}`,
                    {
                        method: "GET",
                        headers: {
                            ...getAuthHeaders(),
    ...
    const fetchDailySchedules = useCallback(
        async (plannerId, year, month, day) => {
            ...
            try {
                const response = await fetch(
                    `${API_BASE_URL}/api/team-planner/${plannerId}/schedule/daily/${year}/${month}/${day}`,
                    {
                        method: "GET",
                        headers: {
                            ...getAuthHeaders(),
    ...
    const createCategory = useCallback(
        ...
        [getAuthHeaders, fetchCategories, handleError, checkAuth]
    );
    ...
    const updateCategory = useCallback(
        async (plannerId, categoryId, updateData) => {
            ...
            try {
                const response = await fetch(
                    `${API_BASE_URL}/api/team-planner/${plannerId}/category/${categoryId}`,
                    {
                        method: "PUT",
                        headers: {
                            ...getAuthHeaders(),
    ...
    const createTodo = useCallback(
        async (plannerId, scheduleId, todoData) => {
            ...
            try {
                const response = await fetch(
                    `${API_BASE_URL}/api/team-planner/${plannerId}/schedule/${scheduleId}/todo`,
                    {
                        method: "POST",
                        headers: {
                            ...getAuthHeaders(),
    ...
    const updateTodo = useCallback(
        async (plannerId, scheduleId, todoId, updateData) => {
            ...
            try {
                const response = await fetch(
                    `${API_BASE_URL}/api/team-planner/${plannerId}/schedule/${scheduleId}/todo/${todoId}`,
                    {
                        method: "PUT",
                        headers: {
                            ...getAuthHeaders(),
    ...
    const createTimeVote = useCallback(
        async (plannerId, voteData) => {
            ...
            try {
                const response = await fetch(
                    `${API_BASE_URL}/api/team-planner/${plannerId}/time-vote`,
                    {
                        method: "POST",
                        headers: {
                            ...getAuthHeaders(),
    ...
    const submitTimeVote = useCallback(
        async (plannerId, voteId, availableDateTimes) => {
            ...
            try {
                const response = await fetch(
                    `${API_BASE_URL}/api/team-planner/${plannerId}/time-vote/${voteId}`,
                    {
                        method: "POST",
                        headers: {
                            ...getAuthHeaders(),
    ...
    const searchSchedulesByKeyword = useCallback(
        async (plannerId, keyword) => {
            ...
            try {
                const response = await fetch(
                    `${API_BASE_URL}/api/team-planner/${plannerId}/search?keyword=${encodeURIComponent(
                        keyword
                    )}`,
                    {
                        method: "GET",
    ...
    const searchSchedulesByUser = useCallback(
        async (plannerId, userId) => {
            ...
            try {
                const response = await fetch(
                    `${API_BASE_URL}/api/team-planner/${plannerId}/search?userId=${userId}`,
                    {
                        method: "GET",
                        headers: {
                            ...getAuthHeaders(),
